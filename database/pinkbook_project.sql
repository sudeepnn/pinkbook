...
CREATE TABLE `project` (
  ...
  PRIMARY KEY (`projid`),
  KEY `abc_idx` (`usn`),
  CONSTRAINT `abc` FOREIGN KEY (`usn`) REFERENCES `student` (`usn`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `project` VALUES ('4sf20cs031','01','Billing system','No proper Billing system ','Billing system');
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `project_BEFORE_INSERT` BEFORE INSERT ON `project` FOR EACH ROW BEGIN
	  IF NEW.projid = '' or NEW.projectname= '' or NEW.problem= '' or new.conclusion= ''  THEN
