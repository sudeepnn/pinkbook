...
public class admin_users extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 10, 240, 64));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userbig.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 50, 50));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            PreparedStatement psmt=con.prepareStatement("select * from faculty");
            ...
            while(rs.next())
            {
                ...
                for(int i=1;i<n;i++)
                {
                    ...
                    v.add(rs.getString("fpassword"));
                    v.add(rs.getString("fmail"));
                    v.add(rs.getString("fphone"));
                    v.add(rs.getString("fgender"));
                }
                dtm.addRow(v);
            }
        }
